...
Tag BBCode dapat dimunculkan dengan mengklik tombol *markup* yang tertera pada toolbar editor post. Pada saat tombol ini diklik tanpa ada teks yang dipilih, tag akan ditampilkan pada area yang sedang aktif pada editor post. Sebaliknya, dengan memilih teks sebelum mengklik tombol, teks tersebut akan dikelilingi oleh tag yang diinginkan.
