...
BBCode, sebagaimana bahasa *markup* lainnya, memformat teks dengan sistem tag yang ditandai oleh sepasang karakter kurung siku (`[]`). Tag ini dibagi menjadi tag "pembuka" dan tag "penutup", yang dibedakan melalui penyertaan garis miring (`/`). Secara khusus, tag penutup berisi garis miring tepat setelah kurung dibuka, sedangkan tag terbuka tidak disertakan.
