...
Pada sebagian tag, terdapat argumen tambahan yang disampirkan pada tag pembuka melalui tanda sama dengan (`=`). Argumen ini digunakan untuk menunjukkan URL, ukuran huruf, dan berbagai elemen lainnya.
