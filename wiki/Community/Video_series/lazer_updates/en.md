...
| 2 | [why you don't play lazer](https://www.youtube.com/watch?v=ZR4ewKxWNKc) | ::{ flag=US }:: [pishifat](https://osu.ppy.sh/users/3178418) and ::{ flag=AU }:: [peppy](https://osu.ppy.sh/users/2) reflects on the common reasons people are reluctant about migrating to osu!(lazer) while walking across the shores of Japan.|
