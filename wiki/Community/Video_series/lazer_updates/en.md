...
**lazer updates** is a video series hosted by ::{ flag=US }:: [pishifat](https://osu.ppy.sh/users/3178418) and ::{ flag=AU }:: [peppy](https://osu.ppy.sh/users/2) that outlines the recent changes made to [osu!(lazer)](https://github.com/ppy/osu) as well as its development process. The series is intended to
...
| 5 | [what's going on with mapping](https://www.youtube.com/watch?v=OM_RBwsqmUY) | ::{ flag=US }:: [pishifat](https://osu.ppy.sh/users/3178418) takes a look on the discourses around the mapping/modding community as well as the repurposing of the [Nomination Assessment Team](/wiki/People/Nomination_Assessment_Team). |
