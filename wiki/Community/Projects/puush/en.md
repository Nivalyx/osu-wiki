...
Later that year, in order to further make the service sustainable with minimal user income, puush disabled registrations for all new accounts altogether — although existing users may continue to use the service as usual.
