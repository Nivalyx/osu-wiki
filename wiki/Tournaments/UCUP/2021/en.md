...
The **Ulat Cup 2021** (***UCUP 2021***) was a double-elimination 2v2 osu! tournament hosted by ![][flag_ID] [Fre](https://osu.ppy.sh/users/3484548). The tournament was open to all teams of two without any restrictions as long as their captain hails from ![][flag_ID] Indonesia. Despite the change in format from all three previous iterations, the tournament was formally regarded as the 4th instalment of the Ulat Bulu Cup tournament series.
