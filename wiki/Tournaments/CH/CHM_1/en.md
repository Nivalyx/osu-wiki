...
Listed below are the players who managed to qualify into their respective division's Swiss round (along with their respective seed number and average map rank combined from each individual Qualifier beatmaps) in each division.
