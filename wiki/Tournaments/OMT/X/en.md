...
[^ex-qf-2]: This map features a specific win condition in which the player with the lowest miss count wins the map. Additionally, a `!roll 50` command is to be commenced before the to determine which version of the map is going to be played.
