...
5. Unlike other tournaments, OMT X will feature a dedicated pick slot for off-beat maps called the **EX/Special** pick. Maps in this pick slot will have a special playing condition attached to them (e.g. "The map has to be played with Easy") or be outright unconventional.
