...
| Placing | Prize(s) |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | 4 months of osu!supporter for each team member, 3 months of [o!rdr subscription](https://ordr.issou.best/) for each team member, customised profile banner, profile badge |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | 2 months of osu!supporter for each team member, 2 months of [o!rdr subscription](https://ordr.issou.best/) for each team member, customised profile banner |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | 1 month of osu!supporter for each team member, 1 month of [o!rdr subscription](https://ordr.issou.best/) for each team member, customised profile banner |
...
| Streamer | ::{ flag=ID }:: [Xentaaa](https://osu.ppy.sh/users/16998672), ::{ flag=VN }:: [ngoc17](https://osu.ppy.sh/users/12463311) |
...
2. In the lobby, players will have to consecutively play all of the Qualifier beatmaps in the order of NM1 -> NM2 -> NM3 -> NM4 -> NM5 -> HD1 -> HD2 -> HR1 -> HR2 -> DT1 -> DT2 -> DT3.
...
6. The 40 players with the **highest average `%MAX` value** across all the Qualifier beatmaps will advance to the team matchmaking phase.
...
7. Failure to attend in any of the Qualifier lobbies will result in an outright elimination.
...
6. The tiebreaking system works as follows:
   - As the mappools are designed so that the tiebreak occurs when there are exactly three maps left, team captains will be asked by the referee to discreetly ban one of the three remaining beatmaps from the mappool by PM. The one beatmap that ends up not being banned will be played as the tiebreaker.
