...
Di samping itu, suatu berkas tingkat kesulitan juga mengandung data-data terkait waktu kemunculan sampel-sampel audio ([hitsound](/wiki/Beatmapping/Hitsound)) yang didengar oleh pemain di dalam permainan.
...
Dari sudut pandang visual, suatu berkas tingkat kesulitan m [berbagai komponen visual](/wiki/Beatmap) seperti [storyboard](/wiki/Storyboards) dan [skin](/wiki/Skinning) yang kemunculannya dapat diatur melalui menu [Visual Settings](/wiki/Visual_Settings). seperti [kiai time](/wiki/Kiai_time) dan [warna kombo (*combo colour*)](/wiki/Glossary/Combo_colour).
