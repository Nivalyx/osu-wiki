...
Dalam ruang lingkup yang lebih spesifik, seberapa sulit suatu tingkat kesulitan juga dipengaruhi oleh hal-hal seperti kompleksitas [pattern](/wiki/Beatmap/Pattern) yang dipergunakan dan [pengaturan tingkat kesulitan (*difficulty setting*)](/wiki/Beatmap_Editor/Song_Setup#difficulty).
