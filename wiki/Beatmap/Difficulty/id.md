...
Mohon diingat bahwa walaupun sebagian besar beatmap memiliki tingkat kesulitan yang sesuai dengan nama atau warna yang disandangnya, terdapat juga beberapa beatmap yang tingkat kesulitannya jauh menyimpang karena berbagai faktor tertentu. Inilah mengapa [kriteria ranking](/wiki/Ranking_criteria) yang berlaku memberikan aturan dasar yang lebih sesuai untuk menentukan penamaan tingkat kesulitan beatmap dan pembagiannya tanpa harus terpaku dengan *star rating*-nya.
