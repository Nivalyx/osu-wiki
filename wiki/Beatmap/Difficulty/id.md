...
Objek permainan yang terdapat pada suatu tingkat kesulitan akan membentuk berbagai [pola](/wiki/Beatmap/Pattern) yang bervariasi tergantung pada mode permainannya masing-masing. Pola ini akan berpengaruh terhadap tampilan dan nuansa beatmap serta bagaimana beatmap itu sendiri harus dimainkan. Permainan dari suatu tingkat kesulitan juga dapat diubah melalui berbagai [pengaturan tingkat kesulitan](/wiki/Client/Beatmap_editor/Song_setup#difficulty) yang diatur oleh pembuat beatmap atau melalui penggunaan [mod](/wiki/Gameplay/Game_modifier).
