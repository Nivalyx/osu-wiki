...
Per tanggal [7 Agustus 2020](https://osu.ppy.sh/home/changelog/stable40/20200807.3), beatmap dalam kategori [Graveyard](#graveyard), [Work in Progress, dan Pending](#wip-and-pending) mulai berkontribusi terhadap jumlah permainan dan total skor pemain. Seiring dengan perubahan ini, beatmap dalam ketiga kategori ini pun memperoleh statistik permainannya tersendiri (jumlah permainan, tingkat keberhasilan, dan titik-titik kegagalan) pada halamannya masing-masing sebagaimana yang sebelumnya hanya ada pada beatmap [Qualified](#qualified) dan [Ranked](#ranked).
