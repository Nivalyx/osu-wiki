...
Beatmap Ranked merupakan beatmap yang telah memenuhi standar [kriteria ranking](/wiki/Ranking_criteria) dan diakui sebagai konten resmi. Beatmap dalam kategori ini memungkinkan para pemain untuk saling bersaing dalam papan peringkatnya masing-masing dan memperoleh  [*performance point*](/wiki/Performance_points) dari skor yang ditorehkan. Sekalinya suatu beatmap menyandang status Ranked, status beatmap tersebut tidak akan lagi dapat diubah ke depannya (kecuali pada kasus-kasus tertentu). Beatmap dalam kategori ini ditandai dengan simbol pangkat ganda (![](/wiki/shared/status/ranked.png)) pada layar pemilihan lagu.
