...
Although not mandatory, having guest difficulties can be beneficial in many occasions as it may greatly diversify the mapset and reduce mapping burnout. Guest difficulties are often requested by private messages between creators, although they can also be requested through other means such as the in-game `#mapping` channel or [modding queues](https://osu.ppy.sh/community/forums/60)<!-- TODO: should link to an article about queues, not the forum -->.
