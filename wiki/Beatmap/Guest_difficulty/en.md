...
There are many benefits of featuring Many guest difficulties, and reducing mapping burnouts. Guest difficulties are often requested by private messages between creators, Although GDs can also be requested through other means such as the in-game `#mapping` channel or [modding queues](https://osu.ppy.sh/community/forums/60)<!-- TODO: should link to an article about queues, not the forum -->.
