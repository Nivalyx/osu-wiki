...
Versi ke-2 dari osu!api saat ini sedang dikembangkan pada repositori [osu-web](https://github.com/ppy/osu-web), yang dirancang untuk dapat lebih tangguh dan fleksibel dibanding pendahulunya. Dokumentasi API versi baru ini (tidak dijamin terbaru) dapat ditemukan di [halaman referensi terkaitnya](https://docs.ppy.sh).
