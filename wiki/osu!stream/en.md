...
osu!stream's development began in 2011 as an attempt to introduce a version of osu! that can be played on-the-go following the abandoned [osu! iPhone](https://github.com/ppy/osu-iPhone) project. The game was originally intended as an iOS-exclusive app, as Android's infrastructure at the time meant there were audio latency issues

osu!stream was first teased through [a cryptic YouTube video] on June 2011. Following its public release on August 2011, the details behind the game were elaborated in [osu!monthly \#5](https://osu.ppy.sh/community/forums/topics/59924) along with an interview.
