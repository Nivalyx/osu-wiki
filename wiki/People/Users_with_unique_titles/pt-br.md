...
Vencedores da [OWC 2020](/wiki/Tournaments/OWC/2020) com o título de **osu! Champion**:
...
As competições de mapping Aspire possuem uma variante especial do título de Elite Mapper chamado **Elite Mapper: Aspirant** como prêmio.
...
![][flag_US] [Charles445](https://osu.ppy.sh/users/85000) recebeu este título após já possuir um título de Elite Mapper, então foi "atualizado" para **Elite Mapper II: Aspirant**. ![][flag_KR] [Spectator](https://osu.ppy.sh/users/702598) está atualmente utilizando o título de **osu!catch Champion** ao invés disso.

### Vencedores da competição osu!remix

As competições do osu!remix recompensam o título de **osu!mixer** como prêmio de primeiro lugar.
...
![][flag_NO] [cYsmix](https://osu.ppy.sh/users/272870) e ![][flag_AU] [nekodex](https://osu.ppy.sh/users/102) possuem o título de **osu!musician** por contribuições nos primórdios do sound design do osu! e temas oficiais, e ![][flag_US] [BilliumMoto](https://osu.ppy.sh/users/3862471) optou por ficar com o título de **osu!mixer** quando ele se tornou um Featured Artist.
...
### Vencedores da competição de design de Mascote

O osu!team realizou competições de arte para membros da comunidade terem a chance de projetar ou reprojetar algumas das mascotes do jogo. Vencedores dessas competições, assim como as pessoas que os designs foram por fim utilizados como trabalhos de arte oficial, foram recompensadas o título de **osu!artist**.

- ![][flag_US] [Crowie](https://osu.ppy.sh/users/6894067) projetou **Mocha** e ajudou a produzir bastante arte para o osu!
- ![][flag_ID] [JMC](https://osu.ppy.sh/users/774010) ganhou a competição de [Fan Art 6: osu!taiko mascot](https://osu.ppy.sh/community/contests/2).
- ![][flag_US] [Thievley](https://osu.ppy.sh/users/4717672) reprojetou **Yuzu**.
- ![][flag_ID] [xiemon](https://osu.ppy.sh/users/5203667) projetou **Mani and Mari**.

### Hall da Fama

Esses três usuários foram recompensados com o título de **osu! Hall of Famer** por jogar o jogo ao maior nível e contribuindo naquela época enquanto a comunidade ainda era jovem.
...
Storyboarders que demonstram um talento excepcional em storyboarding e impressionaram a comunidade em geral são recompensados com o título de **Elite Storyboarder**.
...
Esses jogadores conseguiram seus títulos com alguma conquista maluca ou completando um desafio específico.
