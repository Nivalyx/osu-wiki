...
Kategori Qualified sendiri dirintis agar komunitas osu! dapat mengevaluasi beatmap-beatmap yang telah dinyatakan siap untuk di-*rank* secara lebih luas. Apabila ditemukan masalah pada beatmap yang berstatus Qualified, nominasi yang telah diberikan kepada beatmap tersebut sebelumnya akan [dianulirkan](#penganuliran-nominasi-(nomination-reset)) dan beatmap yang bersangkutan akan kembali ditarik ke Pending oleh anggota BN atau NAT.
