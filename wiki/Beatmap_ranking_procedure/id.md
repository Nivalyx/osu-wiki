...
Kategori Qualified sendiri dibuat dengan tujuan agar komunitas osu! secara luas dapat mengevaluasi beatmap-beatmap yang telah dinyatakan siap untuk di-*rank*. Apabila ditemukan masalah pada suatu beatmap yang berstatus Qualified, nominasi milik beatmap tersebut dapat [dianulirkan](#penganuliran-nominasi-(nomination-reset)) dan beatmap yang bersangkutan dapat kembali ditarik ke Pending oleh para anggota BN dan NAT.
