...
Kategori Qualified sendiri dirintis agar komunitas osu! dapat mengevaluasi beatmap-beatmap yang telah dinyatakan siap untuk di-*rank* secara lebih luas. Apabila suatu beatmap yang telah berstatus Qualified ternyata memiliki masalah, nominasi yang telah diberikan kepada beatmap tersebut sebelumnya akan [dianulirkan](#penganuliran-nominasi-(nomination-reset)) dan beatmap yang bersangkutan akan kembali ditarik ke Pending oleh anggota BN atau NAT.
...
Di samping itu, para anggota BN dan NAT juga memiliki [hak veto](/wiki/People/The_Team/Beatmap_Nominators/Beatmap_Veto) yang dapat digunakan untuk memberhentikan proses nominasi yang sedang berlangsung sepenuhnya pada beatmap-beatmap yang mereka tenggarai mengandung masalah yang berada di luar ruang linkup Ranking Criteria..
