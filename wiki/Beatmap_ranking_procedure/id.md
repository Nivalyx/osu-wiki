...
Kategori Qualified sendiri dirintis agar komunitas osu! dapat mengevaluasi beatmap-beatmap yang telah dinyatakan siap untuk di-*rank* secara lebih luas. Apabila ditemukan masalah pada beatmap yang berstatus Qualified, nominasi milik beatmap tersebut dapat [dianulirkan](#penganuliran-nominasi-(nomination-reset)) dan beatmap yang bersangkutan dapat kembali ditarik ke Pending oleh anggota BN atau NAT.
