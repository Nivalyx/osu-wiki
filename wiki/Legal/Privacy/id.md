...
osu! mengandung kode *executable* khusus yang digunakan untuk mendeteksi penggunaan perangkat lunak illegal (*cheat*). Tujuan dari sistem *anti-cheat* ini adalah agar kami dapat mewujudkan lingkungan permainan yang adil dan kompetitif untuk seluruh pemain, namun tanpa memengaruhi performa permainan atau privasi para pengguna.
