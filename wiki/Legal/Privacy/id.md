...
Layaknya berbagai layanan internet lain pada umumnya, layanan kami juga menggunakan *cookie*. Kami hanya akan menggunakan *cookie* milik Anda untuk mempertahankan status sesi dan kredensial login pada perangkat-perangkat aktif yang Anda miliki. Apabila Anda tidak menyetujui penggunaan *cookie* ini, mohon untuk tidak menggunakan layanan kami.
