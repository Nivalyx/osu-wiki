...
Pada saat Anda menggunakan klien osu! untuk menghubungkan diri Anda ke layanan kami, sebuah *string* khusus akan dikirimkan untuk membantu kami dalam mengidentifikasi lingkungan permainan Anda. String tersebut dibuat berdasarkan kombinasi pengenal dari konfigurasi perangkat keras dan perangkat lunak Anda dan di-hash sedemikian rupa sehingga tidak berisi informasi yang dapat diidentifikasi secara pribadi, tetapi dapat digunakan untuk melacak akses Anda saat masuk ke layanan kami.
