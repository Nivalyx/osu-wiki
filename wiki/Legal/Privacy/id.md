...
osu! mengandung kode *executable* khusus yang digunakan untuk mendeteksi penggunaan perangkat lunak illegal (*cheat*). Tujuan dari sistem *anti-cheat* ini adalah untuk menjaga lingkungan permainan yang adil dan kompetitif untuk semua pemain, tetapi tidak memengaruhi performa dari permainan atau privasi pengguna.
