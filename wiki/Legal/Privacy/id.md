...
Kami menggunakan sistem pencatatan kesalahan (*error logging*) yang mengumpulkan informasi teknis dan penggunaan layanan selagi Anda menggunakan layanan kami. Hal ini dapat meliputi alamat IP Anda, nama pengguna Anda, jenis dan versi browser Anda, pengaturan dan lokasi zona waktu Anda, sistem operasi dan *platform* Anda, serta berbagai rincian lainnya seputar perangkat apa yang Anda gunakan untuk mengakses layanan kami.
