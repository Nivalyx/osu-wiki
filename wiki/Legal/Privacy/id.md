...
Sebagai contoh, apabila Anda mengunggah sebuah beatmap dan beatmap tersebut memperoleh status "ranked", beatmap tersebut akan memperoleh *leaderboard*-nya tersendiri yang memungkinkan para pemain lainnya untuk dapat menorehkan skor. Pada tahap ini, Anda tidak akan lagi dapat menghapus beatmap tersebut.
