...
Seperti halnya layanan internet lain pada umumnya, layanan kami juga menggunakan *cookie*. Kami hanya akan menggunakan *cookie* untuk mempertahankan status sesi dan kredensial entri masuk Anda antar berbagai sesi. Apabila Anda tidak dapat menerima keberadaan *cookie* ini, mohon untuk tidak menggunakan layanan kami.
