...
Prior to the announcement of certain [featured artists](wiki/Featured_Artists), from time to time the [Mappers' Guild](/wiki/Mappers_Guild) (through ![][flag_US] [pishifat](https://osu.ppy.sh/users/3178418)) has been expeditiously offering a chance to its members who are in Tier 1 (or higher) or are taking part in certain [quests](wiki/Mappers_Guild#quests) to create exclusive "showcase beatmaps" using songs and other materials that are available in the corresponding featured artists' backlog library. These showcase beatmaps are due to be given a special spotlight in the featured artist newspost and promoted in the [@osugame Twitter](https://twitter.com/osugame) among others, indirectly giving huge publicity to both the beatmaps and the mappers themselves.
