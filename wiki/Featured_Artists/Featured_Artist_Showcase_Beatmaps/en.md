...
Prior to the announcement of certain [featured artists](wiki/Featured_Artists), from time to time the [Mappers' Guild](/wiki/Mappers_Guild) (through ![][flag_US] [pishifat](https://osu.ppy.sh/users/3178418)) has been expeditiously offering its members who have reached Tier 1 (or higher) or have taken part in certain [quests](wiki/Mappers_Guild#quests) a chance to to create exclusive "showcase beatmaps" using songs and other materials available in osu!'s backlog library. These showcase beatmaps are due to be given a special spotlight in the corresponding featured artists' newsposts and be promoted in the [@osugame Twitter](https://twitter.com/osugame) among others, indirectly giving a huge publicity to both the beatmaps and the mappers themselves in the end.
