...
As the Guild itself was running on a closed, application-based entry in its early days, access to upcoming featured artist contents were only restricted a handful of mappers (many of which are of the [osu!](wiki/Game_mode/osu!) game mode) for a while. However, [the Guild's shift to an open and automated entry system in early 2019](wiki/Mapping_and_Modding_Timeline#march.5) has gradually allowed more and more mappers to be able to create showcase beatmaps for upcoming featured artists regardless of their game mode given that they have been either reached Tier 1 (or higher) in [guild rank](/wiki/Mappers_Guild#rewards) or have previously taken part in some certain [guild quests](wiki/Mappers_Guild#quests).

Starting from December 2020, in [MYUKKE.'s featured artist announcmenet](https://osu.ppy.sh/home/news/2020-12-05-new-featured-artist-myukke)
