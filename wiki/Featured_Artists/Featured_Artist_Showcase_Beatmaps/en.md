...
Prior to the announcement of certain [featured artists](wiki/Featured_Artists), from time to time the [Mappers' Guild](/wiki/Mappers_Guild) (through ![][flag_US] [pishifat](https://osu.ppy.sh/users/3178418)) has been offering multiple opportunities to its members that are in Tier 1 (or higher) or are partaking in certain [quests](wiki/Mappers_Guild#quests) to create showcase beatmaps using songs and other materials that have been licensed from the corresponding unannounced featured artists. These showcase beatmaps are due to be promoted in the , giving publicity to both the artists and the mappers themselves.
