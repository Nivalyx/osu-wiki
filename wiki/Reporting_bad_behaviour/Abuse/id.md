...
Setelah itu, blokir atau bisukan (*mute*) pengguna tersebut dengan mengeklik tombol titik tiga pada pojok kanan atas tweet mereka (apabila kamu mengakses Twitter dari *browser* atau aplikasi seluler). Kunjungi [panduan Twitter seputar cara memblokir akun](https://help.twitter.com/id/using-twitter/blocking-and-unblocking-accounts) untuk informasi lebih lanjut.
