...
| This hold note is less than 10ms long! | A hold note is having an unreasonably short length, rendering the map impossible to SS. | Increase the length of the hold note or remove it. | ![](/wiki/shared/mode/mania.png) osu!mania maps only |
