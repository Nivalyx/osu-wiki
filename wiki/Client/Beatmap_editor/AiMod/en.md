...
| Countdown is not allowed in mania mode. | *Self-explanatory* | Uncheck `Enable countdown` in the Design tab of [Song Setup](/wiki/Client/Beatmap_editor/Song_Setup). | ![](/wiki/shared/mode/mania.png) osu!mania maps only |
| Letterboxing is not allowed in mania mode. | *Self-explanatory* | Uncheck `Letterbox during breaks` in the Design tab of Song Setup. | ![](/wiki/shared/mode/mania.png) osu!mania maps only |
| OD rate is suggested to be at least 5. | *Self-explanatory* | Set the `Overall Difficulty` in the "Difficulty" tab in Song Setup to 5 or higher. | ![](/wiki/shared/mode/mania.png) osu!mania maps only. This warning can safely be ignored if the choice of Overall Difficulty in question is intended. |
| OD rate for maps with very few sliders is suggested to be at least 7. | *Self-explanatory* | Set the `Overall Difficulty` in the "Difficulty" tab in Song Setup to 7 or higher. | ![](/wiki/shared/mode/mania.png) osu!mania maps only. This warning can safely be ignored if the choice of Overall Difficulty in question is intended. |
| <!-- Both seem to occur, not sure what changes the value -->OD rate for maps with very few sliders is suggested to be at least 8. | *Self-explanatory* | Set the `Overall Difficulty` in the "Difficulty" tab in Song Setup to 8 or higher. | ![](/wiki/shared/mode/mania.png) osu!mania maps only. This warning can safely be ignored if the choice of Overall Difficulty in question is intended. |
| <!-- potential removal? tried using countdown on taiko maps, and aimod does not complain -->Countdown is not allowed in taiko mode. | *Self-explanatory* | Disable | [](/wiki/shared/mode/taiko.png) osu!taiko maps only |
