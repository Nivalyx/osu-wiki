...
| These two objects exist at the same point in time! | Two objects are on top of each other. This will make the map impossible to rank. | Find the two objects and either move or delete one of them. | |
