...
| This spinner is too short. Auto must achieve at least 1000 bonus points on spinners. | The specified spinner is too short, rendering the map impossible to SS. | Extend the length of the spinner. | |
