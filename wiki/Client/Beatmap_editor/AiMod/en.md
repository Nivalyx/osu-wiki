...
| Slider has an absurdly large amount of points! | *Self-explanatory* | Remove some of the anchor points from your slider. | This warning can safely be ignored if the design of the slider in question is intended, e.g. on complex [slider arts](http://osu.ppy.sh/community/forums/topics/689531) or sliders made using the [Mapping Tools](https://mappingtools.github.io/)' Tumour Generator plugin. |
