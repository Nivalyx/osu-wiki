...
| This combo is very long. Consider splitting it up. | *Self-explanatory* | Split the long combo chain into several group of combos. It is preferred that length of the combos are, at most, 15-18. | Most notable in osu!catch maps, where fruits will ramp up fast on the catcher's plate on long combos. This warning can be safely ignored if the usage of the long combo chain in question is intentional. |
