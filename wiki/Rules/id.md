...
7. **Pada saat terdapat masalah yang tidak terliput oleh peraturan ini, segala sesuatunya akan diputuskan berdasarkan akal sehat dan logika *(common sense)*.** Dalam kasus yang demikian, tim kami berhak untuk mengambil tindakan yang dirasa sesuai dengan situasi dan kondisi yang ada.
