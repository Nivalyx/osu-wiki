...
7. **Pada saat peraturan yang ada tidak memungkinkan untuk diterapkan, segala sesuatunya akan diputuskan berdasarkan akal sehat dan logika *(common sense)*.** Dalam kondisi yang demikian, tim kami berhak untuk mengambil tindakan yang dirasa sesuai dengan situasi dan kondisi yang ada.
