...
7. **Pada saat peraturan yang ada tidak dapat diterapkan, segala sesuatunya akan diputuskan berdasarkan logika dan akal sehat *(common sense)*.** Terkait hal ini, tim kami memiliki hak khusus untuk mengambil tindakan sebagaimana dengan yang dirasa sesuai.
