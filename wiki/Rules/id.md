...
7. **Pada saat peraturan yang ada tidak dapat diterapkan, segala sesuatunya akan diputuskan berdasarkan logika dan akal sehat *(common sense)*.** Dalam situasi yang demikian, tim kami memiliki hak untuk mengambil tindakan sebagaimana yang dirasa sesuai.
