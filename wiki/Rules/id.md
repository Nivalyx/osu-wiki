...
7. **Pada saat peraturan yang ada tidak dapat diterapkan, gunakanlah logika dan akal sehat *(common sense)* untuk memutuskan segala sesuatunya.** Terkait hal ini, pihak administrasi osu! memiliki hak khusus untuk dapat bertindak sebagaimana dengan yang dirasa sesuai oleh kami.
