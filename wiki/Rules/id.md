...
1. **Pastikan kamu memiliki izin untuk menggunakan seluruh konten yang terdapat pada beatmap yang kamu unggah.** Hal ini meliputi lagu, video, *hitsound*, elemen grafis, dan berbagai hal lainnya yang bukan merupakan hasil ciptaanmu sendiri. Apabila kamu tidak yakin ke mana kamu harus mencari konten yang berizin, kamu dapat menggunakan lagu yang tertera pada katalog [Featured Artist](https://osu.ppy.sh/beatmaps/artists) kami. Di samping itu, kamu juga dapat mengacu pada [Pedoman Penggunaan Konten](/wiki/Rules/Content_usage_guidelines) untuk informasi lebih lanjut.
