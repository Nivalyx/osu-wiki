...
Certain songs have a time signature that is not divided into quarter-notes (e.g. `3/4`, `4/4`, `7/4`, ...) but into eighth-notes (e.g. `6/8`, `7/8`, ...). While the current editor does not support these `#/8` time signatures, there are ways to properly incorporate this timing into osu!.
