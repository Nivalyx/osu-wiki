...
Setelah melewati ambang batas tertentu, FPS yang berlebihan tidak akan mendatangkan keuntungan apapun. Agar sumber daya yang tersedia dapat digunakan secara optimal, lazer menggunakan berbagai teknologi mutakhir untuk memastikan jeda input yang ada dapat diminimalkan bahkan pada FPS yang rendah sekalipun.

Lazer akan selalu mengambil input dalam rentang 1000 Hz terlepas dari batasan FPS yang aktif. Oleh karenanya, lazer membatasi FPS dalam permainan hanya pada 1000 FPS.
...
Walaupun. Dalam waktu dekat, kami akan mengupayakan dukungan DirectX (atau yang dikenal dengan "compatibility mode")
