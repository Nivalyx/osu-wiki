...
osu!(lazer) merupakan versi rilisan utama osu! yang akan datang. Versi ini merupakan hasil jerih payah tim kami selama bertahun-tahun dalam menciptakan permainan osu! yang sepenuhnya baru dan modern.

Pada saatnya nanti, apabila semuanya telah siap, osu!(lazer) akan dirilis sebagai pembaruan khusus yang akan menggantikan versi osu! yang saat ini digunakan. Pembaruan ini hanya akan dikeluarkan apabila **para pemain** merasa waktunya telah tepat, dan versi osu! sebelumnya akan tetap didukung hingga sebagian besar pemain telah beralih ke osu!(lazer).
...
| Ruangan multiplayer tanpa batasan ukuran | ![No][false][^multi-room-max] | ![Yes][true] |
