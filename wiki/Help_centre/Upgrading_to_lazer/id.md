...
Kamu dapat mengatur pilihan `Mode tampilan skor` ke `Klasik` untuk mengaktifkan model skor yang "eksplosif" seperti pada stable. Walaupun tidak persis sama, model ini memiliki perilaku yang serupa dengan stable dan akan dapat digunakan untuk berbagai keperluan sekalinya diaktifkan.
