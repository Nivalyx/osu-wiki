...
Terakhir, tidak seperti stable, kami juga ingin memastikan agar kode program lazer dapat terus digunakan ke depannya. Dengan merancang ulang dasar kode yang ada, kami dapat yang ke depannya akan meliputi komponen UI baru, 
