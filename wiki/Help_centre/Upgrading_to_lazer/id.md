...
Kamu dapat mengatur pilihan `Mode tampilan skor` ke `Klasik` untuk menampilkan model skor yang "eksplosif" seperti pada stable. Walaupun tidak sama persis, model ini memiliki perilaku yang sama dengan model stable dan berlaku secara universal.
