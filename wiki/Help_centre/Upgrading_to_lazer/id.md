...
Kamu dapat mengatur pilihan `Mode tampilan skor` ke `Klasik` untuk memperoleh tampilan skor yang "eksplosif" sebagaimana pada stable. Walaupun tampilan skor ini tidak persis sama dengan yang ada di stable, namun 
