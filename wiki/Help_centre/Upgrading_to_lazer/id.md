...
Kamu dapat memperoleh lazer melalui [tautan berikut](https://github.com/ppy/osu#running-osu). Ke depannya, kamu akan dapat beralih ke lazer secara langsung dari dalam permainan (melalui pilihan `Versi rilis` yang terdapat pada menu pengaturan) dan mengunduh lazer dari situs web osu!.
