...
Jalankan panduan pengaturan dasar dan tuju bagian `Perilaku`. Pada layar ini, kamu dapat mengatur perilaku bawaan dari berbagai aspek permainan yang telah berubah antara stable dan lazer. Kamu juga dapat mengatur agar seluruh aspek permainan yang terdapat pada pengaturan ini berperilaku seperti stable hanya dengan sekali klik.
