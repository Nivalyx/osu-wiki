...
Jalankan panduan pengaturan dasar dan tuju bagian `Perilaku`. Di sini, kamu akan dapat melihat daftar berbagai aspek permainan yang perilaku bawaannya telah berubah antara stable dan lazer. Kamu dapat mengatur agar semua hal yang tertera di sini berperilaku seperti stable hanya dengan sekali klik.
