...
Jalankan panduan pengaturan dasar dan tuju bagian `Perilaku`. Pada layar ini, kamu dapat mengatur perilaku bawaan dari berbagai aspek permainan yang telah berubah antara stable dan lazer. Kamu juga dapat mengatur agar semuanya berperilaku seperti stable hanya dengan sekali klik.
