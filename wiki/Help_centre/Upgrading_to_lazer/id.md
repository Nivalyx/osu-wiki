...
| Kemampuan untuk memperbarui beatmap dari dalam permainan | ![Parsial][partial][^map-only] | ![Ya][true][^all-files] |
...
Kami tentunya akan berusaha agar tidak sampai ada skor yang hilang, namun kami **tidak menjamin bahwa skor yang ada pada lazer saat ini akan tetap ada selama-lamanya**. Apabila dirasa perlu, kami dapat sewaktu-waktu mengatur ulang seluruh skor yang ada pada lazer untuk menyeimbangkan permainan.
