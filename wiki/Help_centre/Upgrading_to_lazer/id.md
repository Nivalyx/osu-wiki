...
Walaupun sebagian besar hardware modern dapat menjalankan lazer lebih baik dari stable. Dalam waktu dekat, kami akan mengupayakan dukungan DirectX (atau yang dikenal pada stable dengan istilah "compatibility mode") dan Vulkan, yang memiliki dukungan lintas hardware yang lebih baik dibanding OpenGL.
