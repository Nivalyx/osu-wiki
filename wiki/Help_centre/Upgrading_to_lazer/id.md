...
Jalankan panduan pengaturan dasar dan tuju bagian `Perilaku`. Pada layar ini, kamu akan dapat melihat daftar berbagai aspek permainan yang perilaku bawaannya telah berubah antara stable dan lazer. Kamu dapat mengatur agar semuanya berperilaku seperti stable hanya dengan sekali klik.
