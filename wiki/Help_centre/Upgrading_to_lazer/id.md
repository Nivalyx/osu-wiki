...
Fitur ini saat ini tidak didukung. Meskipun demikian, berhubung fitur ini merupakan salah satu fitur yang banyak diminta, kami kemungkinan akan kembali memperkenalkan fitur ini pada lazer di masa yang akan datang.
...
Telusuri apakah hal yang ingin kamu sampaikan telah dilaporkan sebelumnya melalui fitur [pelacak masalah](https://github.com/ppy/osu/issues) dan [laman diskusi](https://github.com/ppy/osu/discussions) pada repositori GitHub osu!. Apabila kamu tidak menemukan laporan yang sesuai dengan masalahmu, silakan [buat topik diskusi baru](https://github.com/ppy/osu/discussions/new).
...
Kami akan terus mengeluarkan dan menyempurnakan berbagai fitur yang telah banyak diminta secara cepat dan tanggap. Apabila kamu sebelumnya belum pernah mengikuti siklus perkembangan osu!, bersiaplah untuk dihadapkan dengan berbagai kejutan.
...
Kami tentunya sangat ingin menambahkan berbagai keuntungan lainnya di masa yang akan datang, namun untuk saat ini fokus kami masih tertuju pada pengembangan lazer itu sendiri. Oleh karenanya, mohon niatkan pembelian supporter tag kamu untuk... membawa osu! ke arah yang lebih baik!
