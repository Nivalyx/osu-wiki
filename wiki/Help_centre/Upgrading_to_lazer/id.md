...
Lazer menggunakan sistem perhitungan skor khusus yang serupa (namun tidak sama) dengan ScoreV2. Sistem ini masih berada dalam tahap pengembangan, dan kami akan sangat mengapresiasi segala masukan yang terkait dengan penerapan sistem ini baik dalam mode solo, playlist, multiplayer, ataupun yang lainnya.
