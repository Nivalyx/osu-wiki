...
- **2007-10-29:** Forum thread icons were standardized for the ranking process.
    ...
    - Ikon `heart` (![heart icon](/wiki/shared/icon/heart.gif)) digunakan untuk menandai beatmap-beatmap yang telah di-rank. Ikon ini hanya dapat disematkan pada beatmap-beatmap yang telah ditandai dengan ikon bubble sebelumnya, yang secara tidak langsung mengharuskan setiap beatmap Ranked untuk memiliki 2 nominasi.
