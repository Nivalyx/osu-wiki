...
- **2007-10-29:** Forum thread icons were standardized for the ranking process.
    ...
    - Ikon `heart` (![heart icon](/wiki/shared/icon/heart.gif)) digunakan untuk menandai beatmap-beatmap yang telah di-rank. Ikon ini hanya dapat disematkan pada beatmap-beatmap yang telah ditandai dengan ikon bubble sebelumnya, yang secara tidak langsung memastikan terdapatnya 2 nominasi pada setiap beatmap Ranked.
    - Ikon `nuke` (![nuke icon](/wiki/shared/icon/nuke.gif)) digunakan untuk menandai beatmap-beatmap yang berdasarkan berbagai pertimbangan tidak dapat di-rank dalam kondisi apapun karena satu dan lain hal. <!-- https://osu.ppy.sh/forum/t/619 + missing info on flame/nuke -->
