...
- **Tetap bermain!** Selama akunmu di-*restrict*, kamu diperkenan untuk tetap bermain seperti biasa (selama kamu hanya menggunakan akun aslimu!). Skor-skor yang kamu torehkan ketika kamu di-*restrict* akan tetap terkirim, dan kecuali akun Anda dikenai sanksi *rollback*, skor-skor tersebut akan tetap ada setelah *restriction* akunmu dicabut.
- **Tetaplah berperilaku baik.** Kami paham bahwa *restriction* yang kamu peroleh dapat membuat kamu frustasi. Meskipun demikian, anggaplah ini sebagai kesempatan bagimu untuk dapat meluangkan waktu pada hal-hal lainnya. Cobalah untuk menghindari interaksi dengan komunitas osu! selama setidaknya beberapa hari (baik itu melalui Discord, media sosial, ataupun yang lainnya) dan merenungkan hal-hal yang menyebabkan akunmu di-*restrict*.
- **Yakinkan dirimu untuk tidak lagi melanggar peraturan yang berlaku ke depannya.** Restriction jangka panjang adalah hukuman karena melanggar aturan. Jika Anda terus melakukannya selama di-restrict, masa tunggu sebelum Anda dapat mengajukan banding akan diatur ulang menjadi tiga bulan dari pelanggaran terakhir Anda. Hal ini termasuk, misalnya, terus bermain curang, mengakses akun orang lain, atau membuat akun baru untuk menghindari restriction akun.
