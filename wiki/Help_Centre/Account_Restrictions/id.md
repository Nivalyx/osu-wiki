...
- **Kamu telah mengizinkan orang lain untuk bermain dengan menggunakan akun milikmu.** Saling berbagi akses akun (*account sharing*) juga merupakan tindakan yang tidak dibenarkan oleh osu!. Apabila kamu mengizinkan orang lain untuk bermain dengan menggunakan akun milikmu, akun tersebut akan di-*restrict* dan para pengguna yang terlibat akan di-*silence* atau bahkan turut di-*restrict*. Apabila hal ini terjadi secara tidak sengaja, harap beritahukan tim kami sesegera mungkin melalui email pada alamat [accounts@ppy.sh](mailto:accounts@ppy.sh).
