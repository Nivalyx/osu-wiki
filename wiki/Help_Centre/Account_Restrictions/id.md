...
- **Hubungi [account support team](/wiki/People/The_Team/Account_support_team) kami.** Apabila akunmu tetap di-*restrict* setelah 1x24 jam, harap kirimi kami email pada alamat [accounts@ppy.sh](mailto:accounts@ppy.sh) **dengan menggunakan alamat email yang kamu digunakan untuk membuat akunmu**. Pastikan kamu menyertakan nama penggunamu dan rincian seputar hal-hal yang kamu curigai menyebabkan akunmu di-*restrict* dalam email yang kamu kirim. Semakin banyak Anda memberi tahu kami, semakin mudah bagi kami untuk menyelesaikan masalah.
