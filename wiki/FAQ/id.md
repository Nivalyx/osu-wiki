...
Posisi kursormu tidak memiliki pengaruh apapun dalam permainan osu!catch kecuali apabila kamu bermain dengan menggunakan mod [Relax](/wiki/Game_modifier/Relax). Pada mod ini, alih-alih mengikuti input dari keyboard posisi catchermu akan berpindah seiring dengan pergerakan kursor mouse milikmu.
